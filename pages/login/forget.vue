	...
	<view class="content">
		<view class="list">
			...
			<view class="list-call">
				...
				<input class="sl-input" type="text" v-model="email" maxlength="30" placeholder="请输入注册邮箱" />
			</view>
			<view class="list-call">
	...
	export default {
		...
		methods: {
			...
			getcode() {
				...
				//获取邮箱验证码
				var data={email:this.email,key:2}
			...
			bindLogin() {
				...
				var data={password:this.password,email:this.email,code:this.code};
