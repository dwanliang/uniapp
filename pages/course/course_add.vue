<template>
	<view class="container999">
		...
		<view class='line'>
			...
			<view class="lineRight">  
				<test-com beginYear="2000" endYear="2030" ke="1"  @show="start" ></test-com>
			</view>
		</view>
		<view class='line'>
			<view class='lineLeft'>结束时间</view>
			<view class="lineRight">
				<test-com beginYear="2000" endYear="2030" ke="1" @show="end"></test-com>
			</view>
		</view>
...
<script>
	...
	export default{
		...
		data(){
			return{
				// date_start:[8,15],//初始化时间   :date=date_start
				week:0,//星期几
				timeList: [
					{time: '1',week: '星期一'},
					{time: '2',week: '星期二'},
		...
		methods:{
			...
			submit(){//提交
				...
				var data={week:week,time_end:time_end,time_start:time_start,courseName:courseName,courseAddress:courseAddress,courseTeacher:courseTeacher}
				this.$request(apps.api.course_add,data).then(res => {
