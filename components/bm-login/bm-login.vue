        ...
        <view class="input_wrapper">
            <view class="inputItem" :class="{'focus':isFocus.username,'username_error':errorFlag.username}">
                ...
                <view class="inputContent">
                    <input type="text" @focus="focus('username')" @blur="blur('username')" ref="username" placeholder="请输入用户名" @input="inputUsername" auto-focus>
                </view>
            </view>
        ...
        .auto_quickLogin{
            ...
            .autoLogin_wrapper{
                .autoLogin{
                    ...
                    width: 12px;
                    height: 12px;
                    background-image: url("../../static/images/unchosen.png");
                ...
                input[type="checkbox"]:checked + .autoLogin{
                    background-image: url("../../static/images/chosen.png");
                }
                span{
                    margin-left: .2rem;
                }
